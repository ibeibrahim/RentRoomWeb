...
class HouseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($featured_image) {
            ...
            if (!is_dir(storage_path('app/public/featured_house'))) {
                mkdir(storage_path('app/public/featured_house'), 0777, true);
            }

           

            // $path = $featured_image->storeAs('public/featured_house', $featured_image_name);
            ...
            Image::read($featured_image)->resize(400, 300)->toJpeg()->save( storage_path('app/public/featured_house/') . $featured_image_name);
            //   Storage::disk('public')->put('featured_house/'.$featured_image_name,$cropImage);
            // Storage::putFile('public/featured_house/tes.png', $cropImage);
