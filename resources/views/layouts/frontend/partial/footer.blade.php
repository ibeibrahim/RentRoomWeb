    ...
    <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <p> <i class="fas fa-map-marker-alt"></i> Rent Room, Bandung, West Java</p>
            <p><i class="fas fa-phone"></i> +62 01612345678</p>
        ...
        <p class="text-center pb-2 mb-0"> &copy;Rent House Website<b></b></p>
      </div>
    </section>
</footer>